...
jet_img = pygame.transform.scale(pygame.image.load('jet.png'), (100, 100))
bomb_img = pygame.transform.scale(pygame.image.load('bomb.png'), (30, 30))
house_img = pygame.transform.scale(pygame.image.load('house.png'), (100, 100))
explosion_img = pygame.transform.scale(pygame.image.load('pow.png'), (100, 100))
